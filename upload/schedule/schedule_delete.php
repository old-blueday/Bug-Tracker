 ...
 *
 * Version:	$Id: schedule_delete.php,v 1.6 2009/04/18 16:24:44 alex Exp $
 *
 */
...
$sql = "select created_by from ".$GLOBALS['BR_schedule_table']." where schedule_id = '".$_GET['schedule_id']."'";
...
$sql = "delete from ".$GLOBALS['BR_schedule_table']." where schedule_id='".$_GET['schedule_id']."'";
