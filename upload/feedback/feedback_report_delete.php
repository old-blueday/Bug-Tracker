 ...
 *
 * Version:	$Id: feedback_report_delete.php,v 1.9 2009/04/18 15:47:08 alex Exp $
 *
 */
...
$sql = "select summary from proj".$_GET['project_id']."_feedback_table where report_id='".$_GET['report_id']."'";
...
$map_sql = "delete from proj".$_GET['project_id']."_feedback_map_table 
			 where feedback_report_id='".$_GET['report_id']."'";
$report_delete_sql = "delete from proj".$_GET['project_id']."_feedback_table where report_id='".$_GET['report_id']."'";
$content_delete_sql = "delete from proj".$_GET['project_id']."_feedback_content_table where report_id='".$_GET['report_id']."'";
