 ...
 *
 * Version:	$Id: feedback_list.php,v 1.21 2010/07/27 09:24:17 alex Exp $
 *
 */
...
if (($_GET['customer_filter'] != "") && ($_GET['customer_filter'] != "-1")){
	$condition = "customer_id='".$_GET['customer_filter']."'";
}
...
<div id="current_location">
	...
	<a href="../index.php"><?php echo $STRING['title_project_list']?></a> / <?php echo $project_name." ".$STRING['title_feedback']?>
</div>
		...
		<tr>
			<td align="left" nowrap>
				...
				<a href="feedback_list.php?project_id=<?php echo $_GET['project_id']?>">
					<tt class="outline"><?php echo $project_name." ".$STRING['title_feedback']?></tt>
				</a>
			</td>
