 ...
 *
 * Version:	$Id: document.php,v 1.25 2010/07/27 09:24:17 alex Exp $
 *
 */
...
if ($_GET['search_key'] != "") {
	$subject_match = "(subject ".PATTERN_KEYWORD." '%".$_GET['search_key']."%')";
	$desc_match = "(description ".PATTERN_KEYWORD." '%".$_GET['search_key']."%')";
