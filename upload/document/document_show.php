 ...
 *
 * Version:	$Id: document_show.php,v 1.17 2009/04/18 15:32:39 alex Exp $
 *
 */
...
$old_class_sql = "select * from ".$GLOBALS['BR_document_class_table']." where document_class_id in
			(select document_class_id from ".$GLOBALS['BR_document_map_table']." where document_id='".$_GET['document_id']."')
			order by class_name";
