 ...
 *
 * Version:	$Id: document_delete.php,v 1.11 2009/04/18 15:32:39 alex Exp $
 *
 */
...
if (!($GLOBALS['Privilege'] & $GLOBALS['can_delete_document'])) {
	...
	$owner_sql="select * from ".$GLOBALS['BR_document_table']." 
			where document_id='".$_GET['document_id']."' and created_by='".$_SESSION[SESSION_PREFIX.'uid']."'";
...
if ($GLOBALS['SYS_FILE_IN_DB'] == 0) {
	$file_sql = "SELECT filename FROM ".$GLOBALS['BR_document_history_table']." WHERE document_id='".$_GET['document_id']."'";
	...
	$file_sql = "SELECT filename FROM ".$GLOBALS['BR_document_table']." WHERE document_id='".$_GET['document_id']."'";
	$file_result = $GLOBALS['connection']->Execute($file_sql) or DBError(__FILE__.":".__LINE__);
...
$delete_sql="delete from ".$GLOBALS['BR_document_map_table']." where document_id='".$_GET['document_id']."'";
$GLOBALS['connection']->Execute($delete_sql) or DBError(__FILE__.":".__LINE__);

$sql = "delete from ".$GLOBALS['BR_document_history_table']." where document_id='".$_GET['document_id']."'";
$GLOBALS['connection']->Execute($sql) or DBError(__FILE__.":".__LINE__);

$sql = "delete from ".$GLOBALS['BR_document_table']." where document_id='".$_GET['document_id']."'";
$GLOBALS['connection']->Execute($sql) or DBError(__FILE__.":".__LINE__);
