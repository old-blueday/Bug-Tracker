 ...
 *
 * Version:	$Id: document_new.php,v 1.16 2009/05/03 09:01:09 alex Exp $
 *
 */
...
<div id="main_container">
	...
	<div id="sub_container" style="width:90%;">
		...
		<form method="POST" action="document_donew.php" onSubmit="return OnLocalSubmit(this);" name="form1" ENCTYPE="multipart/form-data">
			...
			<?php echo PrintTip($STRING['hint_title'], $STRING['document_upload_hint'].$STRING['colon'].get_cfg_var("upload_max_filesize"))?>
