 ...
 *
 * Version:	$Id: document_history.php,v 1.4 2009/04/18 15:32:39 alex Exp $
 *
 */
...
$sql = "SELECT count(*) FROM ".$GLOBALS['BR_document_history_table']." WHERE document_id='".$_GET['document_id']."'";
