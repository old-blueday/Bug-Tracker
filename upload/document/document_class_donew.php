 ...
 *
 * Version:	$Id: document_class_donew.php,v 1.6 2010/07/27 09:24:17 alex Exp $
 *
 */
...
// Check category name
$check_sql = "select * from ".$GLOBALS['BR_document_class_table']." where class_name='".$_POST['class_name']."'";
