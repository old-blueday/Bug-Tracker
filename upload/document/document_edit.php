 ...
 *
 * Version:	$Id: document_edit.php,v 1.20 2009/05/03 09:01:09 alex Exp $
 *
 */
...
<?php
$old_class_sql = "select * from ".$GLOBALS['BR_document_map_table']." where document_id='".$_GET['document_id']."'";
