 ...
 *
 * Version:	$Id: document_class_doedit.php,v 1.5 2010/07/27 09:24:17 alex Exp $
 *
 */
...
$check_sql = "select * from ".$GLOBALS['BR_document_class_table']." 
			where class_name='".$_POST['class_name']."' and document_class_id!='".$_POST['document_class_id']."'";
...
$sql = "update ".$GLOBALS['BR_document_class_table']." set 
		class_name='".$_POST['class_name']."' where document_class_id='".$_POST['document_class_id']."'";
