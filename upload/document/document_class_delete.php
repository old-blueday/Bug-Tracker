 ...
 *
 * Version:	$Id: document_class_delete.php,v 1.4 2008/11/28 10:35:24 alex Exp $
 *
 */
...
// Get class data
$document_class_sql = "select * from ".$GLOBALS['BR_document_class_table']." where document_class_id='".$_GET['document_class_id']."'";
...
$delete_sql="delete from ".$GLOBALS['BR_document_map_table']." where document_class_id='".$_GET['document_class_id']."'";
$GLOBALS['connection']->Execute($delete_sql) or DBError(__FILE__.":".__LINE__);

$delete_sql="delete from ".$GLOBALS['BR_document_class_table']." where document_class_id='".$_GET['document_class_id']."'";
$GLOBALS['connection']->Execute($delete_sql) or DBError(__FILE__.":".__LINE__);
