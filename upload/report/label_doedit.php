 ...
 *
 * Version:	$Id: label_doedit.php,v 1.2 2009/04/18 16:16:08 alex Exp $
 *
 */
...
$sql = "SELECT label_id FROM ".$GLOBALS['BR_label_table'].
	" WHERE project_id='".$_POST['project_id']."' and label_name='".$_POST['label_name']."' and label_id!='".$_POST['label_id']."'";
$result = $GLOBALS['connection']->Execute($sql) or DBError(__FILE__.":".__LINE__);
$line = $result->Recordcount();
if ($line != 0) {
	ErrorPrintOut("have_same", "label", stripslashes($_POST['label_name']));
}

$sql = "UPDATE ".$GLOBALS['BR_label_table']." SET label_name='".$_POST['label_name']."', 
	color='".$_POST['color']."' WHERE label_id='".$_POST['label_id']."'";
