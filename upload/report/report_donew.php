 ...
 *
 * Version:	$Id: report_donew.php,v 1.21 2009/04/18 16:16:08 alex Exp $
 *
 */
...
$log .= "<p>Set Priority:".$STRING[$GLOBALS['priority_array'][$_POST['priority']]].", 
	Status:".addslashes($statusclass->getstatusname()).", Assign To:";
...
$new_report_sql = "insert into proj".$_POST['project_id']."_report_table( 
	...
	'".$_POST['summary']."', '".$_SESSION[SESSION_PREFIX.'uid']."', $now,'".$_POST['priority']."',
	'".$_POST['status']."','".$version."','".$_POST['assign_to']."',
	'".$_POST['area']."','".$_POST['minor_area']."', $now, '".$_POST['type']."',
	'".$_POST['reproducibility']."', -1, -1, ".$_POST['reported_by_customer'].")";
...
$new_log_sql = "insert into proj".$_POST['project_id']."_report_log_table (
	...
	$report_id, ".$_SESSION[SESSION_PREFIX.'uid'].", $now, '$log', '$filename', '$filedata');";
...
if ($_POST['feedback_report_id']) {
	...
	$feedback_sql = "update proj".$_POST['project_id']."_feedback_table set
			status=2 where report_id='".$_POST['feedback_report_id']."'";
	...
	$new_log_sql = "insert into proj".$_POST['project_id']."_feedback_content_table (
			...
			'".$_POST['feedback_report_id']."', '".$_SESSION[SESSION_PREFIX.'uid']."', $now, '$description');";
	$GLOBALS['connection']->Execute($new_log_sql) or DBError(__FILE__.":".__LINE__);

	// Link the feedback system and internal system
	$query_map = "select * from proj".$_POST['project_id']."_feedback_map_table
			where feedback_report_id='".$_POST['feedback_report_id']."' and 
	...
	if ($map_result->Recordcount() == 0) {
		$map_sql = "insert into proj".$_POST['project_id']."_feedback_map_table(
			feedback_report_id, internal_report_id) values('".$_POST['feedback_report_id']."',
			".$report_id.");";
