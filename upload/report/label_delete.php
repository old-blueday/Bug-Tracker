 ...
 *
 * Version:	$Id: label_delete.php,v 1.3 2009/04/18 16:16:08 alex Exp $
 *
 */
...
$sql = "SELECT * FROM ".$GLOBALS['BR_label_table']." WHERE label_id='".$_GET['label_id']."'";
...
$sql = "DELETE FROM ".$GLOBALS['BR_label_table']." WHERE label_id='".$_GET['label_id']."'";
$GLOBALS['connection']->Execute($sql) or DBError(__FILE__.":".__LINE__);

$sql = "DELETE FROM ".$GLOBALS['BR_label_mapping_table']." WHERE label_id='".$_GET['label_id']."'";
$GLOBALS['connection']->Execute($sql) or DBError(__FILE__.":".__LINE__);
