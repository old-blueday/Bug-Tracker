 ...
 *
 * Version:	$Id: label_admin.php,v 1.1 2008/12/08 09:57:16 alex Exp $
 *
 */
...
$sql = "SELECT * FROM ".$GLOBALS['BR_label_table']." WHERE project_id=".$_GET['project_id']." order by label_name ASC";
...
<div id="main_container">
	...
	<div id="sub_container" style="width:620;">
