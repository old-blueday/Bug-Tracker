 ...
 *
 * Version:	$Id: project_edit.php,v 1.20 2009/04/18 16:16:08 alex Exp $
 *
 */
		...
		<form method="POST" action="project_doedit.php" name="form1" onsubmit="return OnLocalSubmit(this);">
			...
			<tr>
				<td width="100%" class="title" colspan="4">
					<?php echo $STRING['edit']?><?php echo $STRING['colon']?> <a href="project_list.php?project_id=<?php echo $_GET['project_id']?>"><?php echo $project_name?></a>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="content">
<?php
$get_mailto_sql = "select * from ".$GLOBALS['BR_proj_auto_mailto_table']." where project_id='".$_GET['project_id']."' and can_unsubscribe!='t'";
...
echo '
				...
				<td class="content">';
$get_feedback_mailto_sql = "select * from ".$GLOBALS['BR_proj_feedback_mailto_table']." where project_id='".$_GET['project_id']."'";
...
<?php
$get_access_sql = "select * from ".$GLOBALS['BR_proj_access_table']." where project_id='".$_GET['project_id']."'";
