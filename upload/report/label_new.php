 ...
 *
 * Version:	$Id: label_new.php,v 1.2 2008/12/13 09:26:56 alex Exp $
 *
 */
...
<div id="current_location">
	...
	<a href="label_admin.php?project_id=<?php echo $_GET['project_id']?>"><?php echo $STRING['label_management']?></a> /
	<?php echo $STRING['new_label']?>
</div>
	...
	<table width="100%" border="0">
		<tr>
			...
			<td nowrap width="100%" align="right" valign="bottom">
				<a href="label_admin.php?project_id=<?php echo $_GET['project_id']?>"><img src="<?php echo $GLOBALS["SYS_URL_ROOT"]?>/images/return.png" border="0" align="middle"><?php echo $STRING['back']?></a>
			</td>
		</tr>
	</table>

	<div id="sub_container" style="width:700;">
		...
		<div class="aw-box-ml"><div class="aw-box-mr"><div class="aw-box-mc">
			<h3>&nbsp;</h3>
			<form method="POST" action="label_donew.php" name="form1" onsubmit="return check1();">
			<input type="hidden" name="project_id" value="<?php echo $_GET['project_id']?>">
			<table class="table-input-form" align="center">
			<tr>
				<td class="item_prompt_small">
					<?php echo $STRING['label'].$STRING['colon']?>
					<input class="input-form-text-field" type="text" name="label_name" size="30" maxlength="30">
				</td>
			</tr>
			</table>
