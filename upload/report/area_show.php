 ...
 *
 * Version:	$Id: area_show.php,v 1.7 2008/11/28 10:36:38 alex Exp $
 *
 */
...
$area_sql = "select * from ".$GLOBALS['BR_proj_area_table']." where area_parent=0 and project_id='".$_GET['project_id']."' order by area_name";
...
<div id="current_location">
	...
	<?php echo $project_name." ".$STRING['task_force']?>
</div>
