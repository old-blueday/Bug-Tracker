 ...
 *
 * Version:	$Id: project_export.php,v 1.12 2009/07/06 07:04:04 alex Exp $
 *
 */
...
$user_sql = "select * from ".$GLOBALS['BR_user_table']." where user_id='".$_SESSION[SESSION_PREFIX.'uid']."'";
...
<div id="current_location">
	...
	<a href="JavaScript:DocumentChange(document.back_form);" style="cursor: pointer;"><?php echo $project_name?></a> /
