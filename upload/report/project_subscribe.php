 ...
 *
 * Version:	$Id: project_subscribe.php,v 1.6 2008/11/30 03:46:29 alex Exp $
 *
 */
...
$sql = "select ".$GLOBALS['BR_user_table'].".username, ".$GLOBALS['BR_user_table'].".user_id 
		...
		".user_id and project_id = ".$_GET['project_id']." and ".
...
<div id="current_location">
	...
	<?php echo $project_name?> <?php echo $STRING['subscribe_list']?>
</div>
