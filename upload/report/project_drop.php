 ...
 *
 * Version:	$Id: project_drop.php,v 1.13 2009/04/18 16:16:08 alex Exp $
 *
 */
...
$sql = "select project_name from ".$GLOBALS['BR_project_table']." where project_id='".$_GET['project_id']."'";
...
$delete_project_sql="delete from ".$GLOBALS['BR_project_table']." where project_id='".$_GET['project_id']."'";
...
$drop_area_sql="delete from ".$GLOBALS['BR_proj_area_table']." where project_id='".$_GET['project_id']."'";
...
$delete_access_sql = "delete from ".$GLOBALS['BR_proj_access_table']." where project_id='".$_GET['project_id']."'";
$delete_customer_access_sql = "delete from ".$GLOBALS['BR_proj_customer_access_table']." where project_id='".$_GET['project_id']."'";
$delete_mailto_sql = "delete from ".$GLOBALS['BR_proj_auto_mailto_table']." where project_id='".$_GET['project_id']."'";
$delete_schedule_sql = "delete from ".$GLOBALS['BR_schedule_table']." where project_id='".$_GET['project_id']."'";
$delete_feedback_mailto_sql = "delete from ".$GLOBALS['BR_proj_feedback_mailto_table']." where project_id='".$_GET['project_id']."'";
...
while ($row = $get_all_proj_result->FetchRow()){
	...
	$delete_alsosee_sql="delete from proj".$project_id."_seealso_table where see_also_project='".$_GET['project_id']."'";
...
while ($row = $get_all_class_result->FetchRow()) {
	...
	$delete_class_sql = "delete from ".$GLOBALS['BR_faq_map_table']." 
			where faq_class_id='".$faq_class_id."'";
	$GLOBALS['connection']->Execute($delete_class_sql) or DBError(__FILE__.":".__LINE__);
}
$drop_faq_class_sql = "delete from ".$GLOBALS['BR_faq_class_table']." where project_id='".$_GET['project_id']."'";
$drop_faq_content_sql = "delete from ".$GLOBALS['BR_faq_content_table']." where project_id='".$_GET['project_id']."'";
...
// Delete labels
$sql = "select label_id from ".$GLOBALS["BR_label_table"]." WHERE project_id=".$_GET['project_id'];
$result = $GLOBALS['connection']->Execute($sql) or DBError(__FILE__.":".__LINE__);
while ($row = $result->FetchRow()){
	$label_id = $row["label_id"];
	$sql = "DELETE FROM ".$GLOBALS["BR_label_mapping_table"]." WHERE label_id=".$label_id;
	$GLOBALS['connection']->Execute($sql) or DBError(__FILE__.":".__LINE__);
}
$sql = "DELETE FROM ".$GLOBALS["BR_label_table"]." WHERE project_id=".$_GET['project_id'];
$GLOBALS['connection']->Execute($sql) or DBError(__FILE__.":".__LINE__);
