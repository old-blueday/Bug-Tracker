 ...
 *
 * Version:	$Id: feedback_doconfig.php,v 1.8 2010/07/27 09:24:17 alex Exp $
 *
 */
...
$config_sql = "update ".$GLOBALS['BR_feedback_config_table']." set feedback_system_name='".$_POST['feedback_system_name']."', 
		mail_from_name='".$_POST['mail_from_name']."', mail_from_email='".$_POST['mail_from_email']."',
		login_mode='".$_POST['login_mode']."', import_description='".$import_description."',
