 ...
 *
 * Version:	$Id: system_doconfig.php,v 1.11 2010/07/27 09:24:17 alex Exp $
 *
 */
...
if ($_POST['mail_smtp_auth'] == "t") {
	...
	if ($change_password) {
		$change_password_sql = "mail_smtp_password='".$_POST['mail_smtp_password']."',";
	}
}
...
$config_sql = "update ".$GLOBALS['BR_sysconf_table']." set program_name='".$_POST['program_name']."', 
		date_format = '".$_POST['date_format']."',
		auto_redirect='".$_POST['auto_redirect']."', auth_method='".$_POST['auth_method']."',
		imap_server='".$_POST['imap_server']."', imap_port=".$_POST['imap_port'].",

		mail_from_name='".$_POST['mail_from_name']."', mail_from_email='".$_POST['mail_from_email']."',
		mail_function='".$_POST['mail_function']."', mail_smtp_server='".$_POST['mail_smtp_server']."', 
		mail_smtp_port=".$_POST['mail_smtp_port'].", mail_smtp_auth='".$_POST['mail_smtp_auth']."',
		mail_smtp_user='".$_POST['mail_smtp_user']."', ".$change_password_sql."
