 ...
 *
 * Version:	$Id: statistic_feedback_report.php,v 1.10 2008/11/28 10:36:31 alex Exp $
 *
 */
...
if ($_GET['period'] == "period_day") {
	...
	if ($total_project) {
		for ($i = 0; $i < 30; $i++) {
			...
			$sql = "select count(report_id) from proj".$_GET['project_id']."_feedback_table
...
<div id="current_location">
	...
	<?php echo $STRING['statistic_feedback_report']?>
</div>
<div id="main_container">
	<table width="100%" border="0">
		<tr>
			<td nowrap align="left">
				<img src="<?php echo $GLOBALS["SYS_URL_ROOT"]?>/images/outline_statistic_feedback.png" width="48" height="48" align="middle" border="0">
				<tt class="outline"><?php echo $STRING['statistic_feedback_report']?></tt>
			</td>
...
?>
	...
	<div id="sub_container" style="width:660;">
...
for ($i = 0; $i < count($args); $i++) {
	...
	echo '
			<tr>
				<td class="'.$td_class.'" align="center">'.$key.'</td>
				<td class="'.$td_class.'">
