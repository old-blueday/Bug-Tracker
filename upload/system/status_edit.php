 ...
 *
 * Version:	$Id: status_edit.php,v 1.12 2009/05/03 08:59:48 alex Exp $
 *
 */
...
$sql = "select * from ".$GLOBALS['BR_status_table']." where status_id='".$_GET['status_id']."'";
...
<div id="main_container">
	...
	<div id="sub_container" style="width:450;">
