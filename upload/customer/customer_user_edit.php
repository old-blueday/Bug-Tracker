 ...
 *
 * Version:	$Id: customer_user_edit.php,v 1.12 2009/04/18 15:21:11 alex Exp $
 *
 */
...
$sql = "select * from ".$GLOBALS['BR_customer_user_table']." where customer_user_id='".$_GET['customer_user_id']."'";
