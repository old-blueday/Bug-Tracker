 ...
 *
 * Version:	$Id: customer_edit.php,v 1.11 2009/04/18 15:21:11 alex Exp $
 *
 */
...
$sql = "select * from ".$GLOBALS['BR_customer_table']." where customer_id='".$_GET['customer_id']."'";
...
for ($i=0; $i < sizeof($project_array); $i++) {
	...
	$check_list = "select * from ".$GLOBALS['BR_proj_customer_access_table']." where customer_id='".$_GET['customer_id']."' and project_id='$project_id'";
