 ...
 *
 * Version:	$Id: customer_user_doedit.php,v 1.12 2010/07/27 09:24:17 alex Exp $
 *
 */
...
$sql = "select customer_id from ".$GLOBALS['BR_customer_user_table']." where customer_user_id='".$_POST['customer_user_id']."'";
...
$sql = "update ".$GLOBALS['BR_customer_user_table']." set customer_id='".$_POST['customer_id']."', 
		realname='".$_POST['realname']."',
		email='".$_POST['email']."', language='".$_POST['language']."', 
		account_disabled='".$account_disabled."', 
		auto_cc_to='".$auto_cc_to."' where customer_user_id='".$_POST['customer_user_id']."'";
...
if ($change_password) {
	$passwd_sql = "update ".$GLOBALS['BR_customer_user_table']." 
		set password='".md5($_POST['password1'])."' where customer_user_id='".$_POST['customer_user_id']."'";
