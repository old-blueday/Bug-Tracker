 ...
 *
 * Version:	$Id: customer_user_delete.php,v 1.9 2009/04/18 15:21:11 alex Exp $
 *
 */
...
$sql = "select customer_id,email from ".$GLOBALS['BR_customer_user_table']." where customer_user_id='".$_GET['customer_user_id']."'";
...
$delete_sql="delete from ".$GLOBALS['BR_customer_user_table']." where customer_user_id='".$_GET['customer_user_id']."'";
$GLOBALS['connection']->Execute($delete_sql) or DBError(__FILE__.":".__LINE__);

$delete_sql="delete from ".$GLOBALS['BR_customer_user_tmp_table']." where email='".$email."'";
$GLOBALS['connection']->Execute($delete_sql) or DBError(__FILE__.":".__LINE__);
