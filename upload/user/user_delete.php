 ...
 *
 * Version:	$Id: user_delete.php,v 1.11 2009/04/18 16:25:01 alex Exp $
 *
 */
...
$sql = "select username from ".$GLOBALS['BR_user_table']." where user_id='".$_GET['user_id']."'";
...
$delete_sql="delete from ".$GLOBALS['BR_user_table']." where user_id='".$_GET['user_id']."'";
$delete_filter_sql="delete from ".$GLOBALS['BR_filter_table']." where user_id='".$_GET['user_id']."'";
$delete_access_sql="delete from ".$GLOBALS['BR_proj_access_table']." where user_id='".$_GET['user_id']."'";
$delete_mailto_sql="delete from ".$GLOBALS['BR_proj_auto_mailto_table']." where user_id='".$_GET['user_id']."'";

$update_area_sql = "update ".$GLOBALS['BR_proj_area_table']." set owner=-1 where owner='".$_GET['user_id']."'";
$delete_login_log = "delete from ".$GLOBALS['BR_login_log_table']." where user_id='".$_GET['user_id']."'";
$delete_syslog_log = "delete from ".$GLOBALS['BR_syslog_table']." where user_id='".$_GET['user_id']."'";
$delete_schedule_sql = "delete from ".$GLOBALS['BR_schedule_table']." where created_by='".$_GET['user_id']."'";

$delete_doc_create_by = "update ".$GLOBALS['BR_document_table']." set created_by=-1 where created_by='".$_GET['user_id']."'";
$delete_doc_history_create_by = "update ".$GLOBALS['BR_document_history_table']." set created_by=-1 where created_by='".$_GET['user_id']."'";
$delete_proj_create_by = "update ".$GLOBALS['BR_project_table']." set created_by=-1 where created_by='".$_GET['user_id']."'";
