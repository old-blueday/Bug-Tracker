 ...
 *
 * Version:	$Id: user_new.php,v 1.14 2008/11/30 03:46:29 alex Exp $
 *
 */
...
<?php
$get_lang_sql = "select language from ".$GLOBALS['BR_user_table']." where user_id=".$_SESSION[SESSION_PREFIX.'uid'];
