 ...
 *
 * Version:	$Id: group_edit.php,v 1.13 2008/11/30 03:46:29 alex Exp $
 *
 */
...
$group_sql = "select * from ".$GLOBALS['BR_group_table']." where group_id='".$_GET['group_id']."'";
...
?>    
			...
			<fieldset>
				...
				<table class="table-input-form" align="center">
<?php
$group_status_sql = "select * from ".$GLOBALS['BR_group_allow_status_table']." where group_id='".$_GET['group_id']."'";
