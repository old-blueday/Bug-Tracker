 ...
 *
 * Version:	$Id: group_delete.php,v 1.8 2009/04/18 16:25:01 alex Exp $
 *
 */
...
$sql = "select group_name from ".$GLOBALS['BR_group_table']." where group_id='".$_GET['group_id']."'";
...
$delete_sql="delete from ".$GLOBALS['BR_group_table']." where group_id='".$_GET['group_id']."'";
$update_user="update ".$GLOBALS['BR_user_table']." set group_id=-1 where group_id='".$_GET['group_id']."'";
$delete_status_sql = "delete from ".$GLOBALS['BR_group_allow_status_table']." where group_id='".$_GET['group_id']."'";
