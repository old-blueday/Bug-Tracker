 ...
 *
 * Version:	$Id: filter_setting.php,v 1.12 2008/11/30 10:36:41 alex Exp $
 *
 */
...
<?php
$filter_sql = "select * from ".$GLOBALS['BR_filter_table']." where user_id='".$_SESSION[SESSION_PREFIX.'uid']."' order by filter_name";
