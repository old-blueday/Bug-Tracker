 ...
 *
 * Version:	$Id: faq_admin.php,v 1.16 2009/04/18 15:36:07 alex Exp $
 *
 */
...
$get_class_sql = "select * from ".$GLOBALS['BR_faq_class_table']." where project_id='".$_GET['project_id']."'";
...
$condition = "where project_id='".$_GET['project_id']."'";
...
<?php 
$perpage_sql = "select perpage from ".$GLOBALS['BR_user_table']." where user_id='".$_SESSION[SESSION_PREFIX.'uid']."'";
