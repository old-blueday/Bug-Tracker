 ...
 *
 * Version:	$Id: faq_class_doedit.php,v 1.8 2010/07/27 09:24:17 alex Exp $
 *
 */
...
// Get project data
$faq_class_sql = "select * from ".$GLOBALS['BR_faq_class_table']." where faq_class_id='".$_POST['faq_class_id']."'";
...
$check_sql = "select * from ".$GLOBALS['BR_faq_class_table']." 
			where project_id='".$project_id."' and class_name='".$_POST['class_name']."' and faq_class_id!='".$_POST['faq_class_id']."'";
...
$sql = "update ".$GLOBALS['BR_faq_class_table']." set 
		class_name='".$_POST['class_name']."' where faq_class_id='".$_POST['faq_class_id']."'";
