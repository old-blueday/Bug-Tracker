 ...
 *
 * Version:	$Id: faq_delete.php,v 1.8 2008/11/28 10:36:21 alex Exp $
 *
 */
...
// Get class data
$faq_class_sql = "select * from ".$GLOBALS['BR_faq_content_table']." where faq_id='".$_GET['faq_id']."'";
...
$delete_sql="delete from ".$GLOBALS['BR_faq_map_table']." where faq_id='".$_GET['faq_id']."'";
$GLOBALS['connection']->Execute($delete_sql) or DBError(__FILE__.":".__LINE__);
    
$delete_sql="delete from ".$GLOBALS['BR_faq_content_table']." where faq_id='".$_GET['faq_id']."'";
$GLOBALS['connection']->Execute($delete_sql) or DBError(__FILE__.":".__LINE__);
