 ...
 *
 * Version:	$Id: faq_class.php,v 1.12 2009/04/18 15:36:07 alex Exp $
 *
 */
...
<?php 
	$sql = "select * from ".$GLOBALS['BR_faq_class_table']." where project_id='".$_GET['project_id']."' order by class_name ASC";
