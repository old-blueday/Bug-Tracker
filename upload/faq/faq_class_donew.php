 ...
 *
 * Version:	$Id: faq_class_donew.php,v 1.9 2010/07/27 09:24:17 alex Exp $
 *
 */
...
$check_sql = "select * from ".$GLOBALS['BR_faq_class_table']." 
			where project_id='".$_POST['project_id']."' and class_name='".$_POST['class_name']."'";
...
$sql = "insert into ".$GLOBALS['BR_faq_class_table']."(class_name, project_id)
		values('".$_POST['class_name']."', '".$_POST['project_id']."')";
