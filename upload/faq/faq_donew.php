 ...
 *
 * Version:	$Id: faq_donew.php,v 1.11 2010/07/26 09:05:25 alex Exp $
 *
 */
...
$sql = "insert into ".$GLOBALS['BR_faq_content_table']."(question, answer,
		...
		verified_date) values('".$_POST['question']."', '".$_POST['answer']."', 
		'".$_POST['project_id']."', '".$_SESSION[SESSION_PREFIX.'uid']."',
		$now, $now, '".$_POST['is_verified']."', ".$_POST['assign_to'].",
...
for ($i=0; $i < sizeof($all_belong_class); $i++) {
	...
	$sql = "insert into ".$GLOBALS['BR_faq_map_table']."(faq_id, faq_class_id) 
			values('$faq_id', '".$all_belong_class[$i]."')";
	$GLOBALS['connection']->Execute($sql) or DBError(__FILE__.":".__LINE__);
}
