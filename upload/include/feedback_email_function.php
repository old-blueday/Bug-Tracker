 ...
 *
 * Version:	$Id: feedback_email_function.php,v 1.15 2010/07/27 09:24:17 alex Exp $
 *
 */
/*
...
function SendUpdateCustomerUserEamil($email, $password, $type)
{
	...
	if ($type == "password") {
		...
		$message .= '<p>Your password on '.$feedback_system_name.' has been changed.</p>';
	} else {
		$subject = "Welcome to ".$feedback_system_name."!!";
		$message .= '<p>Your account on '.$feedback_system_name.' has been created.</p>';
	}
