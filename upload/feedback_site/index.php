 ...
 *
 * Version:	$Id: index.php,v 1.12 2008/11/28 10:36:09 alex Exp $
 *
 */
...
<?php
	...
	while ($row = $sql_result->FetchRow()){
		...
		$visible_sql="select * from ".$GLOBALS['BR_proj_customer_access_table']." where customer_id='".$_SESSION[SESSION_PREFIX.'feedback_customer']."' and project_id='$project_id'";
		...
		if ($line != 0) {
			...
			<tr>
				...
				<td class="line'.($count%2).'">
					<a href="project_list.php?project_id='.$project_id.'">'.$project_name.'</a>
				</td>
