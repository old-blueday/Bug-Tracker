 ...
 *
 * Version:	$Id: report_donew.php,v 1.11 2008/11/28 10:36:10 alex Exp $
 *
 */
...
$get_max_id = "select max(cust_report_id) from proj".$_POST['project_id']."_feedback_table where customer_id=".$_SESSION[SESSION_PREFIX.'feedback_customer'];
...
$new_report_sql = "insert into proj".$_POST['project_id']."_feedback_table( 
		...
		priority, version, reproducibility) values('$cust_report_id', 
		'".$_SESSION[SESSION_PREFIX.'feedback_customer']."', '".$_POST['summary']."', 
		'".$_SESSION[SESSION_PREFIX.'feedback_email']."', $now, '".$_POST['type']."', 1,
		'".$_POST['priority']."',
		'".$_POST['version']."', '".$_POST['reproducibility']."')";
...
$new_log_sql = "insert into proj".$_POST['project_id']."_feedback_content_table (
		...
		$report_id, '".$_SESSION[SESSION_PREFIX.'feedback_email']."', $now, '$log', '$filename', '$filedata');";
