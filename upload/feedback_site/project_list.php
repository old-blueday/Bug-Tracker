 ...
 *
 * Version:	$Id: project_list.php,v 1.18 2010/07/27 09:24:17 alex Exp $
 *
 */
...
if ( isset($search_key) && (preg_match("/^#+[0-9]+[0-9]*$/", $search_key))) {
	...
	$get_report_sql = "select * from proj".$_GET['project_id']."_feedback_table 
				where cust_report_id='$search_report_id' and 
				customer_id='".$_SESSION[SESSION_PREFIX.'feedback_customer']."'";
