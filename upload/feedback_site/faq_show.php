 ...
 *
 * Version:	$Id: faq_show.php,v 1.7 2008/11/28 10:36:09 alex Exp $
 *
 */
...
// Get FAQ Content
$sql = "select * from ".$GLOBALS['BR_faq_content_table']."  where faq_id='".$_GET['faq_id']."' and is_verified='t'";
...
<div id="main_container">
	...
	<div id="sub_container" style="width:90%;">
...
$old_class_sql = "select * from ".$GLOBALS['BR_faq_map_table']." where faq_id='".$_GET['faq_id']."'";
...
$get_class_sql = "select * from ".$GLOBALS['BR_faq_class_table']." where project_id='".$project_id."'";
