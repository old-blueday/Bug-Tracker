 ...
 *
 * Version:	$Id: user_doedit.php,v 1.9 2009/07/07 15:13:52 alex Exp $
 *
 */
...
$sql = "update ".$GLOBALS['BR_customer_user_table']." set realname='".$_POST['realname']."',
		language='".$_POST['language']."' where customer_user_id='".$_SESSION[SESSION_PREFIX.'feedback_uid']."'";
...
if ($change_password) {
	$passwd_sql = "update ".$GLOBALS['BR_customer_user_table']." 
		set password='".md5($_POST['password1'])."' where customer_user_id='".$_SESSION[SESSION_PREFIX.'feedback_uid']."'";
