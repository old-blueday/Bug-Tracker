 ...
 *
 * Version:	$Id: user_edit.php,v 1.9 2009/04/18 15:53:44 alex Exp $
 *
 */
...
$sql = "select * from ".$GLOBALS['BR_customer_user_table']." where customer_user_id='".$_SESSION[SESSION_PREFIX.'feedback_uid']."'";
...
$sql = "select * from ".$GLOBALS['BR_customer_table']." where customer_id='".$customer_id."'";
$result = $GLOBALS['connection']->Execute($sql) or DBError(__FILE__.":".__LINE__);
if ($result->Recordcount() != 1) {
	WriteSyslog("error", "syslog_not_found", "customer", __FILE__.":".__LINE__);
